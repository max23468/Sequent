...
- il writer richiede valore base atteso e mapping qualificato collegato a `SRC-08`, applica i vincoli del campo presenti nel catalogo, modifica soltanto valori scalari e restituisce gli stessi byte per un no-op;
- il confronto a tre vie separa modifiche ufficiali, modifiche locali e conflitti senza scegliere automaticamente in caso di divergenza.
