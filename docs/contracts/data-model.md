...
L’acquisizione usa separatamente le proprietà del convertitore ufficiale SuccessioniOnLine per collegare i record DIZ al catalogo canonico. Gli indici del record identificano soggetti, cespiti e posizioni ripetute anche quando più elementi condividono lo stesso modulo; i target mancanti vengono creati e il legame resta registrato nei metadati dell’artefatto per rendere la riparazione idempotente. Valori esistenti divergenti non vengono sovrascritti. Record storici, metadati interni e contenuti senza destinazione univoca restano consultabili nel DIZ originale e sono conteggiati esplicitamente.

La mappatura di acquisizione non autorizza la scrittura: l’export continua a usare soltanto mapping qualificati mediante prova puntuale di round-trip ufficiale. Gli allegati incorporati sono materializzati come documenti per hash; l’assenza di allegati nell’archivio sorgente viene mostrata come evidenza distinta dagli eventuali documenti consegnati separatamente.
