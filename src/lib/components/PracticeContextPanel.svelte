...
<div class="practice-context-panel">
  <div class="context-next-step"><span>Prossimo passo</span><strong>{data.subjects.length === 0 ? "Aggiungi il defunto e i beneficiari" : data.assets.length === 0 ? "Registra i beni e le passività" : "Completa i controlli della dichiarazione"}</strong></div>
  ...
  <div class="context-links"><a href="?sezione=checks">Apri i controlli</a><a href="?sezione=exports">Apri il riepilogo</a></div>
</div>
